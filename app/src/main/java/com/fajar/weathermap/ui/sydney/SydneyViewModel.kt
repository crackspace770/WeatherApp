...
class SydneyViewModel(private val context: Context) : ViewModel() {
    ...
    companion object {
        private const val TAG = "SydneyViewModel"
        private const val WEATHER_DATA_KEY = "sydney_data"
    }

    init {
        fetchWeatherData(-33.8679, 151.2073)
    }
